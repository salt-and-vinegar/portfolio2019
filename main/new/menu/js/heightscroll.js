    ...
    $(function(){
        ...
        */
        ...
        var lH = $("#fullpage div.bgimg:last-child").height();//마지막 섹션높이
        ...
        for(var i = 0; i<$("#fullpage div.bgimg").length; i++){
            if(i==$("#fullpage div.bgimg").length-1){
                /*
                ...
                */
                pos[i]=$("#fullpage div.bgimg:eq("+i+")").offset().top-lastH;
               
               }else{
        pos[i] = $("#fullpage div.bgimg:eq("+i+")").offset().top
        }
            /*
        ...
        $(window).scroll(function(){  
            $("#fullpage div.bgimg").each(function(){
